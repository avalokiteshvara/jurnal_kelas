    ...
    <div class="container" style="margin-top:40px;padding-top: 50px">
      <div class="profile profile--close profile--open">
        <button class="profile__avatar" id="toggleProfile">
          <img src="<?php echo base_url() . 'assets/signin/images/signin_avatar.png'?>" alt="Avatar" />
        </button>
          ...
          <div class="profile__form">
            <div class="profile__fields">
              ...
              <div class="profile__footer">
                ...
                <a href="<?php echo site_url('signin/signin_as_guest')?>" style="float:right">Login as Guest</a>             
              </div>
