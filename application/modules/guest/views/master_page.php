...
<html lang="en">
   <head>
      ...
      <script> var site_url = '<?php echo site_url('guest/')?>'; </script>
          ...
          <nav class="main-header navbar navbar-expand navbar-white navbar-light">
            ...
            <ul class="navbar-nav">
               ...
               <li class="nav-item d-none d-sm-inline-block">
                  <a href="<?php echo site_url('guest')?>" class="nav-link">Beranda</a>
               </li>
               <!-- li class="nav-item d-none d-sm-inline-block">
            ...
            <div class="sidebar">
               ...
               <nav class="mt-2 main-menu">
                  <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                      <li class="nav-item">
                        <a href="<?php echo site_url('guest')?>" class="nav-link">
                     ...
                     <li class="nav-item">
                        <a href="<?php echo site_url('guest/jurnal-kelas')?>" class="nav-link">
