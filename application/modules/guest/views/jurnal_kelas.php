...
<table class="table table-bordered table-responsive" id="monitoring">
  <thead class="thead-dark">
    <tr>
      ...
      <th id="th_9" scope="col" class="text-center">Jam - 9 <!--<h6 class="font12">00:00 s/d 00:00</h6> --></th>
      <th id="th_10" scope="col" class="text-center">Jam - 10 <!--<h6 class="font12">00:00 s/d 00:00</h6> --></th>
    </tr>
  </thead>
...
<script> 
    ...
    (function worker() {
      $.ajax({
        url: '<?=site_url('guest/jurnal_kelas/get_ajax');?>',
