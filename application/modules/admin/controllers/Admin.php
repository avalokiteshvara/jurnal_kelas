...
class Admin extends MX_Controller
{
    ...
    public function kelola_pengguna()
    {
        try {
            ...
            $crud->set_table('user');
            $crud->set_subject('Data Pengguna Aplikasi');
            ...
            $crud->required_fields('email', 'password', 'nama_lengkap', 'username');
            $crud->callback_before_insert(array($this, 'encrypt_password_callback'));

            $crud->columns('nama_lengkap', 'email', 'username');
            ...
            $this->breadcrumbs->push('Admin User', '/admin/kelola-pengguna');

            if ($state === 'edit') {
                $this->breadcrumbs->push('Edit', '/admin/kelola-pengguna/edit');
            } elseif ($state === 'add') {
                $this->breadcrumbs->push('Tambah', '/admin/kelola-pengguna/add');
            }
