...
<html lang="en">
   <head>
      ...
      <title>ADMIN | JURNAL KELAS</title>
      ...
      <script> var site_url = '<?php echo site_url('admin/')?>'; </script>
   ...
   <body class="hold-transition sidebar-mini">
      <div class="wrapper">
          ...
          <nav class="main-header navbar navbar-expand navbar-white navbar-light">
            ...
            <ul class="navbar-nav">
               ...
               <li class="nav-item d-none d-sm-inline-block">
                  <a href="<?php echo site_url('admin')?>" class="nav-link">Beranda</a>
               </li>
               <!-- li class="nav-item d-none d-sm-inline-block">
            ...
            <div class="sidebar">
               ...
               <nav class="mt-2 main-menu">
                  <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                     ...
                     <li class="nav-item">
                        <a href="<?php echo site_url('admin/jurnal-kelas')?>" class="nav-link">
                     ...
                     <li class="nav-item">
                        <a href="<?php echo site_url('admin/kelola-pegawai')?>" class="nav-link">
                      ...
                      <li class="nav-item">
                        <a href="<?php echo site_url('admin/kelola-siswa')?>" class="nav-link">
                           <i class="nav-icon fas fa-users"></i>
                           <p>Siswa</p>
                        </a>
                     </li>
                     ...
                     <li class="nav-item">
                        <a href="<?php echo site_url('admin/kelola-jam-aktif')?>" class="nav-link">
                           <i class="nav-icon fas fa-building"></i>
                           <p>Jam Aktif</p>
                        </a>
                     </li>
                     <li class="nav-item">
                        <a href="<?php echo site_url('admin/kelola-kelas')?>" class="nav-link">
                           <i class="nav-icon fas fa-building"></i>
                           <p>Kelas</p>
                        </a>
                     </li>
                     ...
                     <li class="nav-item">
                        <a href="<?php echo site_url('admin/kelola-jadwalpelajaran')?>" class="nav-link">
                     ...
                     <li class="nav-item">
                        <a href="<?php echo site_url('admin/kelola-pengguna')?>" class="nav-link">
                           <i class="nav-icon fas fa-users"></i>
                           <p>Data Pengguna</p>
                        </a>
                     </li>
                     ...
                     <li class="nav-item">
                        <a href="<?php echo site_url('admin/profile/edit/' . $user_id)?>" class="nav-link">
                           <i class="nav-icon fas fa-school"></i>
                           <p>Profile</p>
                        </a>
                     </li>
                     <li class="nav-item">
                        <a href="<?php echo site_url('admin/ganti-password')?>" class="nav-link">
         ...
         <aside class="control-sidebar control-sidebar-dark">
            ...
            <div class="p-3">
               <h5>MENU</h5>
               <!-- <p><a href="<?php echo site_url('admin/ubah-password')?>">Ubah Password</a></p> -->
